...
@Component({
  ...
  <mat-table [dataSource]="dataSource" matSort>
    <ng-container matColumnDef="employee.name">
      ...
      <mat-cell *matCellDef="let cell"><a [routerLink]="['/people', cell.employee.id]"> {{cell.employee.first_name}} {{cell.employee.last_name}}</a></mat-cell>
    </ng-container>
    <ng-container matColumnDef="start">
      <mat-header-cell mat-sort-header *matHeaderCellDef> Start </mat-header-cell>
      <mat-cell *matCellDef="let cell"> {{cell.date_start | date:'shortTime'}} </mat-cell>
    </ng-container>
    <ng-container matColumnDef="end">
      <mat-header-cell mat-sort-header *matHeaderCellDef> End </mat-header-cell>
      <mat-cell *matCellDef="let cell"> {{cell.date_stop | date:'shortTime'}} </mat-cell>
    </ng-container>
    <ng-container matColumnDef="duration">
      <mat-header-cell mat-sort-header *matHeaderCellDef> Total </mat-header-cell>
      <mat-cell *matCellDef="let cell"> {{cell.duration | async | duration:'h:mm:ss'}} </mat-cell>
    </ng-container>
    <!--
